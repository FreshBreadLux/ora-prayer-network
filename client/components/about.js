...
const About = () => (
  <div className="displayFlex flexColumn flexAllCenter">
    ...
    <div className="flex1 vw70 bottomMargin1em">
      <p className="raleway font20 blackText textOpacityPadding">At Ora, we want to help strengthen people's faith by reminding them of the beauty of the One, Holy, Catholic, and Apostolic Church.
      <br /><br />
    ...
    <div className="displayFlex vw70 vh60 bottomMargin1em">
      ...
      <div className="flex1 flexColumn flexJustifyCenter">
        ...
        <p className="raleway font20 blackText textOpacityPadding">We are called to lay our burdens down before God.
        <br /><br />
    ...
    <div className="displayFlex vw70 vh60 bottomMargin1em">
      <div className="flex1 flexColumn flexJustifyCenter">
        ...
        <p className="raleway font20 blackText textOpacityPadding">We are brothers and sisters in Christ.
        <br /><br />
    ...
    <div className="displayFlex vw70 vh60 bottomMargin1em">
      ...
      <div className="flex1 flexColumn flexJustifyCenter">
        ...
        <p className="raleway font20 blackText textOpacityPadding">We show our unity in prayer.
        <br /><br />
    ...
    <div className="displayFlex vw70 vh60 bottomMargin1em">
      <div className="flex1 flexColumn flexJustifyCenter">
        ...
        <p className="raleway font20 blackText textOpacityPadding">We persevere in prayer.
        <br /><br />
