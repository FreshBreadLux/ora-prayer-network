...
const About = () => (
  <div className="displayFlex flexColumn flex1 flexAlignCenter">
    ...
    <div className="aboutMainBlurbDiv">
      <p className="raleway font16 blackText textOpacityPadding">At Ora, we want to help strengthen people's faith by reminding them of the beauty of the One, Holy, Catholic, and Apostolic Church.
      <br /><br />
    ...
    <div className="aboutBlurbDiv">
      ...
      <div className="aboutSubBlurbDiv">
        ...
        <p className="raleway font16 blackText textOpacityPadding">We are called to lay our burdens down before God.
        <br /><br />
    ...
    <div className="aboutBlurbDiv">
      <div className="aboutSubBlurbDiv">
        ...
        <p className="raleway font16 blackText textOpacityPadding">We are brothers and sisters in Christ.
        <br /><br />
    ...
    <div className="aboutBlurbDiv">
      ...
      <div className="aboutSubBlurbDiv">
        ...
        <p className="raleway font16 blackText textOpacityPadding">We show our unity in prayer.
        <br /><br />
    ...
    <div className="aboutBlurbDiv">
      <div className="aboutSubBlurbDiv">
        ...
        <p className="raleway font16 blackText textOpacityPadding">We persevere in prayer.
        <br /><br />
